...
class ClueTypeLocationCreateDialogFragment : DialogFragment() {

	// Use this instance of the interface to deliver action events
	internal lateinit var listener: ClueLocationCreateDialogListener
     ...
     */
	interface ClueLocationCreateDialogListener {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		try {
			listener = targetFragment as ClueLocationCreateDialogListener
